...
const Voters = () => {
  ...
  const handleDelete = useDeleteWithDependencies({
    deleteApi: votersAPI.delete,
    itemLabel: 'this voter',
    successMsg: 'Voter deleted successfully',
    forceSuccessMsg: 'Voter and voter registrations force-deleted successfully',
    forceConfirmMessage: 'Are you sure you want to delete this voter (and all related registration data)?',
    onSuccess: () => { loadVoters(); loadStats(); },
  });
