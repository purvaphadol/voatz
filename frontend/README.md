# Flask Access Control System - React Frontend

A modern React.js frontend for the Flask Access Control System with role-based permissions, multi-tenant support, and comprehensive admin dashboard.

## 🚀 Features

### Authentication & Security
- **JWT-based Authentication** with automatic token management
- **Role-based Access Control** with dynamic permission checking
- **Multi-tenant Architecture** with company-based data isolation
- **Secure API Communication** with automatic token refresh

### User Interface
- **Material-UI Design System** for modern, responsive UI
- **Dynamic Navigation** based on user permissions
- **Real-time Permission Validation** for UI components
- **Mobile-responsive Layout** with collapsible sidebar

### Core Modules
- **Dashboard** - Overview with statistics and recent activities
- **Users Management** - Full CRUD with permission-based access
- **Roles Management** - Role creation and permission assignment
- **Departments** - Department management (placeholder)
- **Companies** - Multi-tenant company management
- **Modules & Permissions** - System configuration
- **User Roles** - Role assignment management
- **Audit Logs** - Activity tracking and monitoring
- **Profile Management** - User profile and account settings

### Advanced Features
- **Dynamic Menu Generation** from backend permissions
- **Permission-based Component Rendering**
- **Data Grid with Filtering, Sorting & Export**
...
- `REACT_APP_API_URL` - Flask backend API URL (default: http://localhost:5000/api)
...
### Navigation
- **Sidebar Navigation** - Permission-based menu items
- **Dynamic Modules** - Backend-driven module list with action counts
...
#### Dashboard
- **Statistics Cards** - Users, Roles, Departments, Audit Logs counts
- **Recent Activities** - Latest audit log entries
- **Permission Overview** - User's available modules and actions
- **System Information** - User and company details

#### Users Management
- **Data Grid** with filtering, sorting, and export
- **CRUD Operations** - Create, Read, Update, Delete users
- **Department Assignment** - Link users to departments
- **Permission-based Actions** - Show/hide based on user permissions

#### Roles Management
- **Role Creation** - Define new roles with descriptions
- **Role Editing** - Update existing role information
- **Permission Assignment** - (Future: Link roles to permissions)
...
- **PermissionContext** - Dynamic permission loading and checking
...
- `GET /menu/sidebar` - Dynamic menu generation
...
1. **CORS Errors**
   - Ensure Flask backend has proper CORS configuration
...
3. **Permission Errors**
   - Check user role assignments in backend
...
- **Advanced Permission Management** - Granular permission assignment UI
- **Real-time Notifications** - WebSocket integration for live updates
- **Advanced Filtering** - Complex search and filter options
- **Bulk Operations** - Multi-select actions for data grids
...
**Built with ❤️ using React.js, Material-UI, and modern web technologies**
